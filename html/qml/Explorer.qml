...
ApplicationWindow {
                    ...
                    ColumnLayout {
                        ...
                        Item {
                            ...
                            Image {
                                ...
                                source: parent.parent.parent.parent.previewItem ? win.fs.iconFor(parent.parent.parent.parent.previewItem) : ""
                            }
                            Label {
                                visible: parent.parent.parent.previewItem === null
                                anchors.centerIn: parent
                        ...
                        Label {
                            visible: parent.parent.previewItem !== null
                            Layout.fillWidth: true
                            text: parent.parent.previewItem ? win.fs.typeLabel(parent.parent.previewItem) : ""
                            color: win.pal.muted
                            font.pixelSize: 11
                            horizontalAlignment: Text.AlignHCenter
                        }
    ...
    component SidebarGroup : Column {
        ...
        Rectangle {
            ...
            color: sgHover.containsMouse ? win.pal.sbHover : "transparent"
            RowLayout {
                anchors.fill: parent
                anchors.leftMargin: 8
                spacing: 6
                Label { text: sgRoot.expanded ? "▼" : "▶"; color: win.pal.muted; font.pixelSize: 9 }
                Image { source: win.fs.iconForGroup(sgRoot.group.kind); Layout.preferredWidth: 14; Layout.preferredHeight: 14; fillMode: Image.PreserveAspectFit }
                Label { text: sgRoot.group.name; color: win.pal.sbText; font.pixelSize: 12; font.bold: true; Layout.fillWidth: true }
            }
            MouseArea { id: sgHover; anchors.fill: parent; hoverEnabled: true; onClicked: sgRoot.expanded = !sgRoot.expanded }
        }
        Repeater {
            model: sgRoot.expanded ? sgRoot.group.children : []
            delegate: SidebarItem { item: modelData; level: 0; width: sgRoot.width }
        }
    }

    component SidebarItem : Column {
        id: siRoot
        property var item
        ...
        Rectangle {
            ...
            color: win.currentId === siRoot.item.id ? win.pal.sbCurrent : (siHover.containsMouse ? win.pal.sbHover : "transparent")
            RowLayout {
                anchors.fill: parent
                anchors.leftMargin: 12 + siRoot.level * 14
                spacing: 4
                Label {
                    text: siRoot.item.children && siRoot.item.children.length > 0 ? (siRoot.expanded ? "▼" : "▶") : " "
                    color: win.pal.muted; font.pixelSize: 8
                    MouseArea { anchors.fill: parent; onClicked: siRoot.expanded = !siRoot.expanded }
                }
                Image { source: win.fs.iconFor(siRoot.item); Layout.preferredWidth: 14; Layout.preferredHeight: 14; fillMode: Image.PreserveAspectFit }
                Label { text: siRoot.item.name; color: win.pal.sbText; font.pixelSize: 12; Layout.fillWidth: true; elide: Text.ElideRight }
            }
            MouseArea { id: siHover; anchors.fill: parent; hoverEnabled: true; onClicked: win.navigate(siRoot.item.id); onDoubleClicked: siRoot.expanded = !siRoot.expanded }
        }
        Repeater {
            model: siRoot.expanded && siRoot.item.children ? siRoot.item.children.filter(function(c){ return c.type !== "file" }) : []
            delegate: SidebarItem { item: modelData; level: siRoot.level + 1; width: siRoot.width }
        }
    }
            ...
            delegate: Rectangle {
                ...
                ColumnLayout {
                    ...
                    Image {
                        ...
                        source: win.fs.iconFor(modelData)
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                RowLayout {
                    ...
                    anchors.leftMargin: 8
                    spacing: 6
                    Image { source: win.fs.iconFor(modelData); Layout.preferredWidth: 16; Layout.preferredHeight: 16; fillMode: Image.PreserveAspectFit }
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    RowLayout {
                        ...
                        Label { Layout.fillWidth: true; Layout.preferredWidth: 100; Layout.leftMargin: 8; text: win.fs.typeLabel(modelData); color: win.isSelected(modelData.id) ? win.pal.selText : win.pal.muted; font.pixelSize: 11 }
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                RowLayout {
                    ...
                    anchors.margins: 10
                    spacing: 14
                    Image { source: win.fs.iconFor(modelData); Layout.preferredWidth: 44; Layout.preferredHeight: 44; fillMode: Image.PreserveAspectFit }
                    ColumnLayout {
                        Layout.fillWidth: true
                        spacing: 3
                        ...
                        Label {
                            text: {
                                var parts = [win.fs.typeLabel(modelData)]
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    ...
                                    RowLayout {
                                        ...
                                        anchors.margins: 10
                                        spacing: 10
                                        Image { source: win.fs.iconFor(modelData); Layout.preferredWidth: 52; Layout.preferredHeight: 52; fillMode: Image.PreserveAspectFit }
                                        ColumnLayout {
